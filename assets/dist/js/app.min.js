...
class BooksApi{constructor(e){this.options={apiUrl:"https://www.googleapis.com/books/v1/volumes?"},this.elements={form:$("#search-form"),queryInput:$("#input"),results:$("#results")},this.registerEvents()}registerEvents(){this.elements.form.on("submit",e=>{e.preventDefault(),this.GetBookName(this.elements.queryInput.val().trim())})}GetBookName(e){let s=this.options.apiUrl,t={q:e,key:"AIzaSyCJWhP9d7LuZY1FF7Iz9H7vvZ-5Le3WtBI"};$.get(s,t).done(e=>{this.displayData(e),console.log(e)}).fail(e=>{console.log(e)})}displayData(e){e.items.forEach(e=>{$("#results").append(`<div class="container">\n      <div class="my-5 text-center display">\n          <img class="card-img-top col-4 image img-thumbnail" src="${e.volumeInfo.imageLinks.thumbnail}"><br>\n          <h2>${e.volumeInfo.title}</h2><br>\n          <p class="para">${e.volumeInfo.description}</p><br>\n          <h3 class"authername">${e.volumeInfo.authors}</h3><br>\n          <a class="btn btn-danger btn-lg myBtn" href="${e.volumeInfo.previewLink}">Read In google</a>\n         </div>\n        </div>`)})}}const getBook=new BooksApi;